...
extern LCM_DRIVER cm_n070icn_dsi_vdo_lcm_drv;
extern LCM_DRIVER hj070ia_lcm_drv;
...
//extern LCM_DRIVER nt35516_qhd_dsi_cmd_lcm_drv; //not found
...
#if defined(CM_N070ICN_DSI_VDO)
	&cm_n070icn_dsi_vdo_lcm_drv,
#endif
